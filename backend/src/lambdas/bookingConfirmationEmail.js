...
exports.handler = (event, context, callback) => {
	...
	var paramsUser = {
		...
		Message: {
			Subject: {
				Charset: 'UTF-8',
				Data: `My Hair Done Booking Confirmation - Booking ID: ${bookingID}.`,
			},
			Body: {
				Html: {
					Charset: 'UTF-8',
            ...
            <h3>Thank you for booking with My Hair Done!</h3>
            <p>Hi ${userName},</p>
            <p>This is your booking confirmation. Below are your booking details. You can also see <a href="https://myhairdone.co.uk/bookings">your bookings</a> at your account at any time.</p>
	...
	var paramsHairdresser = {
		...
		Message: {
			Subject: {
				Charset: 'UTF-8',
				Data: `My Hair Done New Booking - Booking ID: ${bookingID}.`,
			},
			Body: {
				Html: {
					Charset: 'UTF-8',
					Data: `
            <img src="https://myhairdone-portfolioimages.s3-eu-west-1.amazonaws.com/Header+Logo+1200px.png" width="450" height="150" alt="My Hair Done Logo.png"/>
            <h3>Great News! A user has placed a new booking with you.</h3>
            <p>Hi ${hairdresserName},</p>
            <p>There's a new booking waiting for you. Below are the booking details. You can also see <a href="https://myhairdone.co.uk/bookings">your bookings</a> at your account at any time.</p>
